...
import { MONTH_GOAL, WEEK_GOAL } from '@/constants';
import { db } from '@/db';
				...
				<div className='flex flex-col gap-16'>
					<div className='grid gap-4 sm:grid-cols-2'>
						<Card>
							...
							<CardContent>
								<div className='text-sm text-muted-foreground'>of {formatPrice(WEEK_GOAL)} goal</div>
							</CardContent>
							<CardFooter>
						...
						<Card>
							<CardHeader className='pb-2'>
								...
								<CardTitle className='text-4xl'>{formatPrice(lastWeekMonth._sum.amount ?? 0)}</CardTitle>
							</CardHeader>
							<CardContent>
								<div className='text-sm text-muted-foreground'>of {formatPrice(MONTH_GOAL)} goal</div>
							</CardContent>
							<CardFooter>
								<Progress value={((lastWeekMonth._sum.amount ?? 0) * 100) / MONTH_GOAL} />
							</CardFooter>
						</Card>
					</div>
